...
if __name__ == '__main__':
    ...
    parser.add_argument('--atom_enc_mode', type=str, default='basic')
    ...
    for example_idx, r_name in enumerate(tqdm(results_fn_list, desc='Eval')):
        ...
        for sample_idx, (pred_pos, pred_v) in enumerate(zip(all_pred_ligand_pos, all_pred_ligand_v)):
            ...
            # stability check
            pred_atom_type = transforms.get_atomic_number_from_index(pred_v, mode='basic')
            ...
            # reconstruction
            try:
                pred_aromatic = transforms.is_aromatic_from_index(pred_v, mode='basic')
